...
protocol ImagePickerControllerProtocol: class {
...
class ImagePickerController: NSObject {
    ...
    private weak var delegate: ImagePickerControllerProtocol?
    
    public init(presentationController: UIViewController, delegate: ImagePickerControllerProtocol) {
